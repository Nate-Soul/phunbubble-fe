...
const register = () => {
  return (
    <main className="h-screen bg-gray-100 flex items-center justify-center overflow-hidden">
      <div className="register flex flex-1 flex-col justify-center gap-8 p-16 text-white text-center w-1/2 h-full">
      ...
      <div className="flex flex-1 flex-col gap-12 p-16 w-1/2 h-full">
